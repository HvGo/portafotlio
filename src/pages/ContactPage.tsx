        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3">
              {/* Contact Info */}
              <div className="bg-gradient-to-br from-blue-900 to-teal-800 p-8 text-white">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      ...
                      <option value="Dashboard Question">Dashboard Question</option>
                  ...
                  <button 
                    ...
                    className="inline-flex items-center px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-md transition-colors disabled:bg-teal-400"
                  >
                    {isSubmitting ? (
                      <>
